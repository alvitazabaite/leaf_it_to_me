...
export const apiResponseData: Record<string, mockApiResponseOption> = {
    'Yanang': {
        ...
        images: {
            thumb: 'https://cdn.permapeople.org/permapeople-permaculture-plant-database-blank.jpg',
            title: 'https://cdn.permapeople.org/permapeople-permaculture-plant-database-blank.jpg',
        },
    },
    ...
    'Wild Garlic': {
        ...
        data: [
            ...
            {
                key: 'Alternate name',
                value: 'Wild cowleek, Ramsons, Buckrams, Broad-leaved garlic, Wood garlic, Bear leek, Bears garlic',
            },
            {
                key: 'German name',
                value: 'Bärlauch',
            ...
            {
                key: 'Native to',
                value: 'Europe, Asia, Austria, Baltic States, Belarus, Belgium, Bulgaria, Central European Rus, Corse, Czechoslovakia, Denmark, Finland, France, Germany, Great Britain, Greece, Hungary, Ireland, Italy, Netherlands, North Caucasus, North European Russi, Northwest European R, Norway, Poland, Portugal, Sicilia, Spain, Sweden, Switzerland, Transcaucasus, Ukraine',
            },
            {
                key: 'Wikipedia',
            ...
            {
                key: 'Plants of the World Online',
                value: 'https://powo.science.kew.org/taxon/urn:lsid:ipni.org:names:529088-1',
            },
            {
                key: 'Warning',
    ...
    'Silver Fir': {
        ...
        data: [
            ...
            {
                key: 'Native to',
                value: 'Albania, Austria, Belarus, Bulgaria, Corse, Czechoslovakia, France, Germany, Greece, Hungary, Italy, Poland, Romania, Spain, Switzerland, Turkey-in-Europe, Ukraine, Yugoslavia',
            },
            {
                key: 'Introduced into',
                value: 'Belgium, Denmark, Finland, Føroyar, Great Britain, Ireland, Norway, Portugal, Sweden',
            },
            {
                key: 'Plants of the World Online',
                value: 'https://powo.science.kew.org/taxon/urn:lsid:ipni.org:names:60468511-2',
            },
        ],
        description:
    ...
    'American persimmon': {
        ...
        data: [
            ...
            {
                key: 'Plants For A Future',
                value: 'https://pfaf.org/User/Plant.aspx?LatinName=Diospyros virginiana',
            },
            {
                key: 'Native to',
                value: 'Alabama, Arkansas, Connecticut, Delaware, Florida, Georgia, Illinois, Indiana, Iowa, Kansas, Kentucky, Louisiana, Maryland, Mississippi, Missouri, New Jersey, New York, North Carolina, Ohio, Oklahoma, Pennsylvania, South Carolina, Tennessee, Texas, Virginia, West Virginia',
            },
            {
                key: 'Introduced into',
            ...
            {
                key: 'Plants of the World Online',
                value: 'https://powo.science.kew.org/taxon/urn:lsid:ipni.org:names:323180-1',
            },
        ],
        description: '',
    ...
    'Japanese Maple': {
        ...
        data: [
            ...
            {
                key: 'Plants of the World Online',
                value: 'https://powo.science.kew.org/taxon/urn:lsid:ipni.org:names:927504-1',
            },
        ],
        description: '',
    ...
    'Moosewood': {
        ...
        data: [
            ...
            {
                key: 'Native to',
                value: 'Georgia, Indiana, Kentucky, Maryland, Minnesota, New York, Nova Scotia, Ohio, Tennessee, Vermont, Wisconsin',
            },
            {
                key: 'Plants of the World Online',
                value: 'https://powo.science.kew.org/taxon/urn:lsid:ipni.org:names:781446-1',
            },
        ],
        description: '',
